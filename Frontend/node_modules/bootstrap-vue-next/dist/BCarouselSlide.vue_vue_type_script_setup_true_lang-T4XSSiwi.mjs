...
import { b as BvCarouselEvent } from "./classes-BW_GpXTu.mjs";
import { u as useId } from "./useId-t29UARy6.mjs";
import { k as useElementHover, l as useSwipe, o as onKeyStroke } from "./index-CNe4dKrr.mjs";
import { u as useDefaults } from "./useDefaults-DESCdb0p.mjs";
import { u as carouselInjectionKey } from "./keys-BLeKMItg.mjs";
import { g as useIntervalFn, u as useToNumber } from "./index-BkgVGYcq.mjs";
import { _ as _sfc_main$2 } from "./BImg.vue_vue_type_script_setup_true_lang-E3VcFf0S.mjs";
import { i as isEmptySlot } from "./dom-DVb-f0ZG.mjs";
const getSlotElements = (slot, filterBy) => (slot?.() ?? []).reduce((arr, slot2) => {
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const computedStyle = computed(() => ({
      background: `${props.background || parentData?.background.value || "rgb(171, 171, 171)"} none repeat scroll 0% 0%`
    }));
...
//# sourceMappingURL=BCarouselSlide.vue_vue_type_script_setup_true_lang-T4XSSiwi.mjs.map
