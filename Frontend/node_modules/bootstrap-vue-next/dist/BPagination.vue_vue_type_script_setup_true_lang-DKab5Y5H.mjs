import { defineComponent, mergeModels, useModel, useTemplateRef, computed, nextTick, watch, createElementBlock, openBlock, unref, normalizeClass, Fragment, renderList, mergeProps, createBlock, createCommentVNode, renderSlot, createTextVNode, toDisplayString, resolveDynamicComponent, withCtx } from "vue";
...
import { C as CODE_LEFT, a as CODE_UP, b as CODE_RIGHT, c as CODE_DOWN } from "./constants-Cx335y3L.mjs";
      ...
      return openBlock(), createElementBlock("ul", {
        ...
        (openBlock(true), createElementBlock(Fragment, null, renderList(pages.value, (page, index) => {
          return openBlock(), createElementBlock("li", mergeProps({
            ...
            ], 16)) : "button" in page ? (openBlock(), createBlock(resolveDynamicComponent(page.button.is), mergeProps({
              key: 1,
              ref_for: true
            }, page.button, {
...
//# sourceMappingURL=BPagination.vue_vue_type_script_setup_true_lang-DKab5Y5H.mjs.map
