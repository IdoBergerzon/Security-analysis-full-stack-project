import { defineComponent, useSlots, ref, watch, inject, computed, createBlock, openBlock, resolveDynamicComponent, mergeProps, unref, withCtx, createElementBlock, createCommentVNode, renderSlot, createElementVNode, normalizeStyle, toDisplayString, createTextVNode, provide, toRef } from "vue";
import { h as avatarGroupInjectionKey } from "./keys-BLeKMItg.mjs";
import { u as useBLinkHelper, _ as _sfc_main$2 } from "./BLink.vue_vue_type_script_setup_true_lang-Ct47WhzE.mjs";
import { _ as _sfc_main$3 } from "./BBadge.vue_vue_type_script_setup_true_lang-D9DEOOtU.mjs";
import { i as isEmptySlot } from "./dom-DVb-f0ZG.mjs";
import { u as useNumberishToStyle } from "./useNumberishToStyle-CdjRyAvX.mjs";
...
import { u as useToNumber } from "./index-BkgVGYcq.mjs";
const _hoisted_1 = {
  key: 0,
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(resolveDynamicComponent(computedTag.value), mergeProps({
        ...
        type: unref(props).button && !unref(computedLink) ? unref(props).buttonType : void 0,
        disabled: unref(props).disabled || null,
        variant: null,
        onClick: clicked
      }), {
        default: withCtx(() => [
          ...
          ])) : !!unref(props).text ? (openBlock(), createElementBlock("span", {
            key: 2,
            class: "b-avatar-text",
            style: normalizeStyle(textFontStyle.value)
          }, toDisplayString(unref(props).text), 5)) : (openBlock(), createElementBlock("span", _hoisted_4, _cache[0] || (_cache[0] = [
          ...
          showBadge.value ? (openBlock(), createBlock(_sfc_main$3, {
            key: 4,
            pill: unref(props).badgePill,
            "dot-indicator": unref(props).badgeDotIndicator || badgeImplicitlyDot.value,
            variant: unref(props).badgeVariant,
            "bg-variant": unref(props).badgeBgVariant,
            "text-variant": unref(props).badgeTextVariant,
            style: normalizeStyle(badgeStyle.value),
            placement: unref(props).badgePlacement
          }, {
            default: withCtx(() => [
...
//# sourceMappingURL=BAvatarGroup.vue_vue_type_script_setup_true_lang-rJzM2tR7.mjs.map
