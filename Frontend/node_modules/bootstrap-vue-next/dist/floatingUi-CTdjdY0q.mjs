import { computed, ref, shallowRef, watch, getCurrentScope, onScopeDispose, shallowReadonly, unref, defineComponent, mergeModels, useSlots, useAttrs, useModel, useTemplateRef, toRef, onMounted, nextTick, onBeforeUnmount, createElementBlock, openBlock, Fragment, createElementVNode, renderSlot, createVNode, normalizeProps, guardReactiveProps, withCtx, createBlock, createCommentVNode, Transition, mergeProps, withDirectives, normalizeStyle, normalizeClass, createTextVNode, toDisplayString, vShow, toValue as toValue$1, render, h } from "vue";
import { p as useMouse$1, a as onClickOutside } from "./index-CNe4dKrr.mjs";
import { u as useDefaults } from "./useDefaults-DESCdb0p.mjs";
import { r as createSharedComposable, u as useToNumber } from "./index-BkgVGYcq.mjs";
...
export {
  ...
  autoUpdate as c,
  unbind as d,
  resolveActiveStatus as e,
  flip as f,
  resolveContent as g,
  bind as h,
  isBoundary as i,
  resolveDirectiveProps as j,
  offset as o,
  resolveBootstrapCaret as r,
  shift as s,
  useFloating as u
};
//# sourceMappingURL=floatingUi-CTdjdY0q.mjs.map
